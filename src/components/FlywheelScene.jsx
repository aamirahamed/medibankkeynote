...
export default function FlywheelScene() {
  ...
  return (
    ...
    >
      ...
      {/* ── CENTRAL AREA (FLYWHEEL + INTEL CORE) ── */}
      <div style={{
        position: 'relative',
        width: '850px',
        height: '850px',
        ...
        {/* 7 Redesigned Premium Ecosystem Nodes (Glassmorphic Cards) */}
        {stages.map((stage, idx) => {
          ...
          return (
            ...
            >
              {/* Premium Glassmorphic Node Card */}
              <motion.div
                onMouseEnter={() => {
                  setActiveStage(idx);
                  setIsHovered(true);
              ...
              >
                ...
                {/* Micro Signal particle overlay on active node */}
                {isActive && (
                  <motion.div
                    initial={{ opacity: 0 }}
